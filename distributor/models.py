...
from shop.models import Category, SubCategory, BaseCategory
...
class Distributor(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='user_distributors',
    ...
    sub_category = models.ForeignKey(SubCategory, related_name='subcategory_distributor', on_delete=models.CASCADE)

    tags = models.ManyToManyField('Tag', related_name='distributor_tags')
...
class Images(models.Model):
    product = models.ForeignKey(Distributor, related_name='distributor_images', on_delete=models.CASCADE)
...
class Detail(models.Model):
    product = models.ForeignKey(Distributor, related_name='distributor_details', on_delete=models.CASCADE)
...
class Size(models.Model):
    ...
    product = models.ForeignKey(Distributor, related_name='distributor_size', on_delete=models.CASCADE)
...
class Color(models.Model):
    ...
    product = models.ForeignKey(Distributor, related_name='distributor_colors', on_delete=models.CASCADE)
    mode = models.IntegerField(choices=TypeChoices.choices, default=TypeChoices.price)
...
class Physical(models.Model):
    class SendMode(models.IntegerChoices):
        base_price = 1, _('base price')
        site_option = 2, _('site option')
        off = 3, _('off')

    product = models.OneToOneField(Distributor, related_name='distributor_physical', on_delete=models.CASCADE)

    send_mode = models.IntegerField(choices=SendMode.choices, default=SendMode.base_price)
...
class Digital(models.Model):
    product = models.OneToOneField(Distributor, related_name='distributor_digital', on_delete=models.CASCADE)
...
class DigitalProductUrl(models.Model):
    digital = models.ForeignKey(Digital, related_name='distributor_url', on_delete=models.CASCADE)
...
class Price(models.Model):
    ...
    product = models.OneToOneField(Distributor, related_name='distributor_price', on_delete=models.CASCADE)
